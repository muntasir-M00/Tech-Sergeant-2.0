...
function updateClock() {
  ...
  // Convert to your desired format: "18 April, 10:45 pm"
  let formatted = s
    .replace(",", "")           // Remove comma after day
    .toLowerCase()              // Make "PM" → "pm"
    .replace("pm", "pm")
    .replace("am", "am");

  document.getElementById("datetime-tag").textContent = formatted;
}

// Run immediately
updateClock();

// Update every 30 seconds (as you had before)
